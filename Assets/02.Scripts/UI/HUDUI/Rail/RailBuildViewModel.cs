...
public class RailBuildViewModel : ViewModelBase
{
    ...
    public const int INITIAL_STRAIGHT_RAIL_COUNT = 10;
    ...
    public RailBuildViewModel(int bonusStraightRailCount = 0)
    {
        ...
        _slotDic.Add(RailType.Straight, new RailSlotViewModel { RailType = RailType.Straight, OwnedCount = straightCount });
